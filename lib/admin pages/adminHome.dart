...
class _AdminHomePageState extends State<AdminHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: _user!=null ? _user.displayName!=null && _user.displayName.toLowerCase()=="true" ? AdminDrawer(): SignedInDrawer():SignedOutDrawer(),
      body: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: Database().getProducts(context, admin: true),
                      ),
                    ],
                  ),
                ),
